...
![Tools Count](https://img.shields.io/badge/Tools-35-blue)
...
## Developer Tools
- [Base64 Encoder & Decoder](https://cubbbix.com/base64-encoder-decoder/)  
- [Case Converter](https://cubbbix.com/case-converter/)  
- [JSON to TOON Encoder](https://cubbbix.com/json-to-toon-encoder/)  
- [Lorem Ipsum Generator](https://cubbbix.com/lorem-ipsum-generator/)  
- [SEO Text Analyzer](https://cubbbix.com/seo-text-analyzer/)  
- [URL Encoder & Decoder](https://cubbbix.com/url-encoder-decoder/)  
- [Word Counter](https://cubbbix.com/word-counter/)  

---

## Entertainment Tools
- [Christmas Countdown](https://cubbbix.com/christmas-countdown/)  
...
## Finance Tools
- [VAT Calculator](https://cubbbix.com/vat-calculator/)  

---

## Math Tools
- [Binomial Distribution Calculator](https://cubbbix.com/binomial-distribution-calculator/)  
- [Variance Calculator](https://cubbbix.com/variance-calculator/)  

---

## Utilities
- [Color Converter & Picker](https://cubbbix.com/color-converter/)  
- [Password Generator](https://cubbbix.com/password-generator/)  
- [PNG Optimizer](https://cubbbix.com/png-optimizer/)  
...
## Contribute
Suggestions, improvements, and new tool ideas are welcome.  
